...
<html lang="en">
  ...
  <div class="wrapper fixed-left">
    ...
    <div id="content" >
    <form action="../ConexionBotones/UpdateUsuario.php" method="POST" enctype="multipart/form-data" class="row g-3 border">
     
     <div class="formtlo "><h1 class="row justify-content-center">MI CUENTA</h1>
     <label for="exampleFormControlInput1" class="form-label row justify-content-center">Codigo: <?php echo $row['Codigo'] ?></label>
     </div><input name="Codigo" type="hidden" value="<?php echo $row['Codigo'] ?>">
       <div class="col-md-6 mb-3" >
         <label for="exampleFormControlInput1" class="form-label">Nombre</label>
         <input name="Nombre" type="Text" class="form-control" id="exampleFormControlInput1" placeholder="first and last name" required="" value="<?php echo $row['Nombre'] ?>">
       </div>
       <div class="col-md-6 mb-3">
         <label for="exampleFormControlInput1" class="form-label">Cargo Administrativo</label>
         <select name="Cargo" class="form-select"  value="<?php echo $row['Cargo']?>">
       ...
       <div class="col-md-6 mb-3">
         ...
         <input name="Correo" type="email" class="form-control" id="exampleFormControlInput1" placeholder="name@example.com" required="" value="<?php echo $row['Correo']  ?>">
       </div>
       <div class="col-md-6">
         <label for="inputPassword4" class="form-label">Password</label>
         <input name="Contrasena" type="password" class="form-control" id="Contrasena" minlength=8  maxlength=15 placeholder="Min 8- Max 15" required="" value="<?php echo $row['Contrasena']  ?>">
         <div class="ub1"><input type="checkbox" onclick="verpassword()" >Mostrar contraseña</div>
       </div>
         
       <div class="col-md-6 mb-3">
         <label for="formFile" class="form-label">Foto</label>
         <input  type="file" name="Foto" class="form-control" id="formFile" required="" value="<?php $row['Foto']?>">
        </div>       
       <div align="center">  
