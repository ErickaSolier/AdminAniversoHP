...
$Categoria=mysqli_query($conn,"SELECT Codigo, Nombre FROM Categoria");
...
<html lang="en">
  ...
  <div class="wrapper fixed-left">
    ...
    <div id="content" >
    <div align="center"> 
      <div  class="col-md col-md-8 border  my-5">
        <div class="formtlo my-4"><h1 class="row justify-content-center">AGREGAR SUBCATEGORIA</h1></div>
        <form class="form-floating row g-3" action="../ConexionBotones/ConexionSubcategoria.php" method="post">
          <div align="center">  
            <div class="col-md col-md-8 my-4">
              <div class="form-floating ">
                
                <select name="Nombre" class="form-select" aria-label="Default select example" id="floatingInputGrid" >
              ...
              <br>
              <div class="form-floating  ">
                <input Name="NSubcategoria"type="Text" class="form-control" id="floatingInputGrid"required="">
                <label for="floatingInputGrid">SubCategoria</label>
              </div>
