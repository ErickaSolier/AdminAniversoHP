  ...
  <div class="wrapper fixed-left">
    ...
    <div id="content" >
      ...
      <div  class="col-md col-md-8 border  my-5">
        <div class="formtlo my-4"><h1 class="row justify-content-center">AGREGAR CATEGORIA</h1></div>
        <form class="form-floating row g-3" action="../ConexionBotones/ConexionCategoria.php" method="POST">
          <div align="center">  
            <div class="col-md col-md-8 my-4">
              <div class="form-floating  ">
                <input Name="Nombre"type="Text" class="form-control" id="floatingInputGrid" required="">
